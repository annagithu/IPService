...
namespace IPService.Classes
{
    public static class Helper
    {
        ...
        private const string Example = "пример: --file-log C:\\.projects\\IPService\\journals\\test.log --file-output C:\\.projects\\IPService\\journals\\output.txt --time-start 01.01.2024 --time-end 01.06.2024";
